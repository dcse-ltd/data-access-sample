...
public class CustomerMappingProfile : Profile
{
    public CustomerMappingProfile(ICurrentUserService currentUserService)
    {
        CreateMap<Entities.Customer, CustomerDto>()
            ...
            .ForMember(dest => dest.CreatedOn, opt => opt.MapFrom(src => src.Auditing.AuditInfo.CreatedAtUtc))
            .ForMember(
                dest => dest.CreatedBy, 
            ...
            .ForMember(dest => dest.ModifiedOn, opt => opt.MapFrom(src => src.Auditing.AuditInfo.ModifiedAtUtc))
